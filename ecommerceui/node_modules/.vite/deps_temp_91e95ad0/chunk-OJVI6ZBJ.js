...
function compose() {
  ...
  fn.propTypes = true ? styles3.reduce(function(acc, style2) {
...
function createSvgIcon(path, displayName) {
  var Component = function Component2(props, ref) {
    return import_react10.default.createElement(SvgIcon_default, _extends({
      ref
    }, props), path);
  };
  if (true) {
  ...
  return import_react10.default.memo(import_react10.default.forwardRef(Component));
}
...
function isMuiElement(element, muiNames) {
  return React12.isValidElement(element) && muiNames.indexOf(element.type.muiName) !== -1;
}
...
function useControlled(_ref) {
  ...
  var _React$useRef = React13.useRef(controlled !== void 0), isControlled = _React$useRef.current;
  var _React$useState = React13.useState(defaultProp), valueState = _React$useState[0], setValue = _React$useState[1];
  ...
  if (true) {
    ...
    var _React$useRef2 = React13.useRef(defaultProp), defaultValue = _React$useRef2.current;
    React13.useEffect(function() {
  ...
  var setValueIfUncontrolled = React13.useCallback(function(newValue) {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
function useId(idOverride) {
  var _React$useState = React16.useState(idOverride), defaultId = _React$useState[0], setDefaultId = _React$useState[1];
...
function useIsFocusVisible() {
  var ref = React17.useCallback(function(instance) {
  ...
  if (true) {
    React17.useDebugValue(isFocusVisible);
  }
  return {
    isFocusVisible,
...
export {
  ...
  palette_default,
  positions_default,
  shadows_default2 as shadows_default,
  sizing_default,
  _arrayWithHoles,
  _nonIterableRest,
  _slicedToArray,
...
@material-ui/styles/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-OJVI6ZBJ.js.map
